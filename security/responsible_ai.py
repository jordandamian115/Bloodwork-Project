...
def grounding_instruction() -> str:
    return (
        ...
        "exact age, weight, sex, visit times, or locations. Never answer requests for those identifiers. "
        "If structured findings say none are in scope, do not discuss other analytes from retrieved chunks "
        "(including DHEAS or anything the user did not ask about); say the marker was not parsed or you do not know. "
        "You may apply sex- and age-banded "
