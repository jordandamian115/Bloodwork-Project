...
- Source id: `medlineplus-cholesterol`
- URL: https://medlineplus.gov/lab-tests/cholesterol-levels/
- Cluster: lipids
- Topics: lipids, ldl, hdl, triglycerides
- Teaching target: Lipid panel interpretation aligned with NIH-style desirable levels (total/LDL/HDL/TG).
...
URL of this page: https://medlineplus.gov/lab-tests/cholesterol-levels/
