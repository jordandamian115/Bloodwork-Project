...
- Source id: `medlineplus-iron`
- URL: https://medlineplus.gov/lab-tests/iron-tests/
- Cluster: complementary
- Topics: iron, tibc, transferrin
- Teaching target: Iron studies panel (serum iron, TIBC, transferrin saturation).
...
URL of this page: https://medlineplus.gov/lab-tests/iron-tests/
